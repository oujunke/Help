...
namespace Help.WinFormsHelp.WinApi.Win32Api.User32
{
    public static class Api
    {
        ...
        /// <returns></returns>
        public static extern IntPtr SetWindowsHookEx(int hookid, MS.Win32..HookProc pfnhook, IntPtr hinst, int threadid);
