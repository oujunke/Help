...
namespace Help.ImageHelp
{
    public class ShapeConvolutional2D
    {
        ...
        {
            ShapeConvolutional2D convolutional2D = new ShapeConvolutional2D(motherBitmap);
            convolutional2D.GenerateKernel(sonBitmap);
            convolutional2D.Convolution(out int mx, out int my);
